...
import com.walmart.store.controller.DriverController;
...
public class DriverControllerTest {
	...
	public void setup() {
		...
		driverDetailsDTO = new DriverDetails("1", 1.2, 2.4);
	}
	...
	public void testPublishToKafka() throws Exception {
		String driverDetail = mapper.writeValueAsString(driverDetailsDTO);
		this.mockMvc.perform(post("/drivers/location").contentType(MediaType.APPLICATION_JSON).content(driverDetail))
				.andExpect(status().isOk());
	}
